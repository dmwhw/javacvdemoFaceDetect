...
//ffmpeg -i rtsp://admin:admin123@192.168.50.187:554/profile1 -vcodec copy -acodec copy -f flv -y rtmp://192.168.50.212/live/test
public class ApullStream {
	//public static Logger logger = Logger.getLogger(ApullStream.class);
	...
	private static void recordByFrame(final FFmpegFrameGrabber grabber, final FFmpegFrameRecorder recorder, final Boolean status) {
		//logger.info("开始启动无敌爬流线程");
